...
__all__ = ['RNNEncDecSCCTCModel']


class RNNEncDecSCCTCModel(ASRModel, ExportableEncDecModel, ASRModuleMixin):
    """Base class for encoder decoder RNN-SC-CTC-based models."""
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = RNNEncDecSCCTCModel.from_config_dict(self._cfg.preprocessor)
        self.encoder = RNNEncDecSCCTCModel.from_config_dict(self._cfg.encoder)
        ...
        self.decoder = RNNEncDecSCCTCModel.from_config_dict(self._cfg.decoder)
        ...
        if hasattr(self._cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = RNNEncDecSCCTCModel.from_config_dict(self._cfg.spec_augment)
        else:
    ...
    def change_vocabulary(self, new_vocabulary: List[str], decoding_cfg: Optional[DictConfig] = None):
        ...
        if self.decoder.vocabulary == new_vocabulary:
            ...
            del self.decoder
            self.decoder = RNNEncDecSCCTCModel.from_config_dict(new_decoder_config)
            del self.loss
            self.loss = CTCLoss(
                num_classes=self.decoder.num_classes_with_blank - 1,
                zero_infinity=True,
    ...
    def input_types(self) -> Optional[Dict[str, NeuralType]]:
        ...
        return {
            ...
            "cached_kvs": NeuralType(None, AcousticEncodedRepresentation(), optional=True),
            "cached_kv_lens": NeuralType(('B'), LengthsType(), optional=True),
        }
    ...
    def forward(
        ...
        preprocess_args = {'input_signal': input_signal, 'length': input_signal_length,}
        ...
        encoder_args = {
            ...
            'cached_kv_lengths':cached_kv_lens
        }
