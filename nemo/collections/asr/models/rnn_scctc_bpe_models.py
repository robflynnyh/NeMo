...
from nemo.collections.asr.models.rnn_scctc_models import RNNEncDecSCCTCModel
from nemo.collections.asr.parts.mixins import ASRBPEMixin
from nemo.collections.asr.parts.preprocessing.perturb import process_augmentations
from nemo.core.classes.common import PretrainedModelInfo
from nemo.utils import logging, model_utils

__all__ = ['RNNEncDecSCCTCModelBPE']


class RNNEncDecSCCTCModelBPE(RNNEncDecSCCTCModel, ASRBPEMixin):
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = RNNEncDecSCCTCModelBPE.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
